...
semantic command output instead; `Meta`/Super retains line selection. When the
effective `mouse-shift-capture` policy releases application capture, `Shift`
restores local button handling; captured wheel input remains reported. Hold
