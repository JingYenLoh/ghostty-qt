...
- `abnormal-command-exit-runtime` remains planned. Fast nonzero Linux exits do
  not yet receive Ghostty's runtime-threshold classification and dedicated
  abnormal-exit presentation; this is separate from `wait-after-command`.
