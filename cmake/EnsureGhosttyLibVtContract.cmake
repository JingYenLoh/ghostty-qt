foreach(required_variable
        ZIG_EXECUTABLE SOURCE_DIR ZIG_OUT_DIR EXPECTED_CONTRACT CONTRACT_STAMP
        PREPARED_STAMP SHARED_LIBRARY STATIC_LIBRARY HEADER LOCK_FILE
        WRITE_STAMP_SCRIPT)
...
if(NOT EXPECTED_CONTRACT MATCHES "^[0-9a-f]+$"
...
file(LOCK "${LOCK_FILE}" GUARD PROCESS TIMEOUT 1800
...
function(outputs_are_ready output_variable)
    ...
    foreach(output IN ITEMS
            "${SHARED_LIBRARY}" "${STATIC_LIBRARY}" "${HEADER}")
