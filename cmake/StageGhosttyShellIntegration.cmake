foreach(
    _ghostty_qt_required_variable
    IN
    ITEMS SOURCE_DIR STAGE_DIR PATCH_EXECUTABLE PATCH_FILE VALIDATE_SCRIPT
)
    if(NOT DEFINED ${_ghostty_qt_required_variable})
        message(FATAL_ERROR "${_ghostty_qt_required_variable} is required")
    endif()
endforeach()
...
execute_process(
    COMMAND
        "${PATCH_EXECUTABLE}" --batch --forward --fuzz=0 --no-backup-if-mismatch
