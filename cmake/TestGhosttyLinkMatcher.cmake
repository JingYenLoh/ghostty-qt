foreach(required_variable
        ZIG_EXECUTABLE SOURCE_DIR URL_SOURCE CACHE_DIR GLOBAL_CACHE_DIR
        LOCK_FILE OPTIMIZE)
...
if(lock_result)
    message(FATAL_ERROR "Unable to lock Ghostty link matcher tests: ${lock_result}")
endif()

execute_process(
    COMMAND "${ZIG_EXECUTABLE}" build test -j2
        --cache-dir "${CACHE_DIR}"
